...
\midrule
\multirow{3}{*}{Small}
 & (5,5,5)     & \textbf{0.148} & 0.598 & 0.362 & 0.249 & 0.243 & 0.169 & 0.194 $\pm$ .005 \\
 & (5,7,5)     & \textbf{0.199} & 0.623 & 0.455 & 0.446 & 0.447 & 0.307 & 0.265 $\pm$ .028 \\
 & (10,15,5)   & \textbf{0.192} & 0.619 & 0.418 & 0.446 & 0.488 & 0.300 & 0.232 $\pm$ .019 \\
\midrule
\multirow{3}{*}{Medium}
 & (15,15,5)   & \textbf{0.087} & 0.533 & 0.266 & 0.288 & 0.315 & 0.096 & 0.099 $\pm$ .008 \\
 & (15,20,5)   & \textbf{0.138} & 0.616 & 0.363 & 0.480 & 0.508 & 0.207 & 0.172 $\pm$ .013 \\
 & (20,30,5)   & \textbf{0.176} & 0.638 & 0.448 & 0.548 & 0.584 & 0.295 & 0.214 $\pm$ .014 \\
\midrule
\multirow{3}{*}{Large}
 & (30,30,10)  & \textbf{0.015} & 0.355 & 0.078 & 0.164 & 0.093 & 0.016 & \textbf{0.015} $\pm$ .004 \\
 & (30,40,10)  & 0.045 & 0.407 & 0.177 & 0.256 & 0.136 & \textbf{0.032} & 0.042 $\pm$ .007 \\
 & (40,50,10)  & 0.051 & 0.331 & 0.150 & 0.261 & 0.144 & \textbf{0.028} & 0.036 $\pm$ .005 \\
\midrule
\multirow{3}{*}{Battlefield}
 & (50,50,15)  & 0.157 & 0.361 & 0.156 & 0.195 & \textbf{0.077} & 0.088 & 0.087 $\pm$ .004 \\
 & (50,70,15)  & 0.992 & 0.390 & 0.171 & 0.268 & 0.099 & 0.080 & \textbf{0.080} $\pm$ .003 \\
 & (70,100,15) & 0.993 & 0.403 & 0.177 & 0.306 & 0.106 & 0.100 & \textbf{0.098} $\pm$ .001 \\
\midrule
 & \textbf{Mean} & 0.266 & 0.490 & 0.268 & 0.326 & 0.270 & 0.143 & \textbf{0.128} \\
\bottomrule
\end{tabular}
\end{table*}

At matched inference effort, the mean objective across the twelve
configurations is 0.128, against 0.143 for the strongest neural baseline
(Sequential), a 10.7\% relative reduction. Every non-exact baseline is beaten
on the mean.
...
beaten: 0.326, 0.270 and 0.143 against our 0.128. Removing target selection
...
by tier. Against SCIP we lose all six Small and Medium configurations, tie at
...
strongest learned baseline, we win 7 of 12, tie at (50,70,15), and lose four:
(5,5,5) by 0.025, (15,15,5) by 0.003, (30,40,10) by 0.010 and (40,50,10) by
0.008. Against all learned baselines together we are best at 7 of 12, the
remaining loss being (50,50,15), where POMO reaches 0.077 against our 0.087.

The losses share a shape worth naming. All four against Sequential are
configurations where the sequential decoder's per-weapon re-observation pays
off, either because the instance is small enough that deciding one weapon at a
time costs little, or because the firing set is tight enough that the order of
commitment matters. We do not win everywhere, and the mean advantage is
carried by the larger configurations rather than spread evenly.

All results are reported over ten seeds, and checkpoints are selected on a
validation set drawn at the training size range rather than on the
configurations reported here (Section~\ref{sec:data}). Across-seed standard
deviations run from 0.001 to 0.028 and are largest at the Small tier, where a
single instance carries more weight. They are small relative to the margin
over Greedy and the auction everywhere, but at (15,15,5) the spread of 0.008
exceeds our 0.003 margin over Sequential, so that configuration should be read
as a tie rather than a loss.
...
\midrule
(5,5,5)     & 0.1935 & 0.1827 & 0.1739 & 0.1635 & 12.1 \\
(5,7,5)     & 0.2654 & 0.2574 & 0.2491 & 0.2439 & 9.3 \\
(10,15,5)   & 0.2322 & 0.2314 & 0.2254 & 0.2195 & 13.9 \\
(15,15,5)   & 0.0992 & 0.0975 & 0.0965 & 0.0942 & 14.3 \\
(15,20,5)   & 0.1723 & 0.1705 & 0.1652 & 0.1587 & 19.3 \\
(20,30,5)   & 0.2145 & 0.2126 & 0.2086 & 0.2018 & 18.4 \\
(30,30,10)  & 0.0151 & 0.0147 & 0.0141 & 0.0134 & 22.6 \\
(30,40,10)  & 0.0415 & 0.0408 & 0.0393 & 0.0374 & 23.5 \\
(40,50,10)  & 0.0356 & 0.0352 & 0.0343 & 0.0318 & 23.9 \\
(50,50,15)  & 0.0874 & 0.0874 & 0.0874 & 0.0873 & 21.2 \\
(50,70,15)  & 0.0797 & 0.0796 & 0.0795 & 0.0792 & 21.5 \\
(70,100,15) & 0.0975 & 0.0974 & 0.0973 & 0.0972 & 21.4 \\
\midrule
\textbf{Mean} & 0.1278 & 0.1256 & 0.1225 & \textbf{0.1190} & 18.4 \\
\bottomrule
\end{tabular}
\end{table}

Two patterns matter. The gain is modest in absolute terms, 0.1278 to 0.1190,
a 6.9\% relative reduction across the full budget, because the construction
...
accepted flip is at index 9 on average, and the $K{=}10$ and $K{=}30$ columns
differ by 0.005. At the Large and Battlefield configurations the last accepted
...
each, twelve held-out configurations.}
...
\textbf{without (reported)} & \textbf{0.1278} & \textbf{0.1256} & \textbf{0.1225} & \textbf{0.1190} \\
\midrule
...
are selected by best validation performance rather than taken at the final
step. Selection uses instances disjoint from those reported, but it is still a
selection, and the twenty candidates per run make the chosen number optimistic
relative to a predetermined checkpoint. The spread is wide: best validation
lands between 0.1500 and 0.1681 across the ten runs, while final-step values
reach 0.4753. Three runs were still improving when training stopped, so a
longer schedule might do better. Appendix~\ref{app:traces} gives the full
trace. What tempers this is that the ten selected checkpoints then agree on
the held-out benchmark, with across-seed standard deviation under 0.008 at
nine of the twelve configurations.
